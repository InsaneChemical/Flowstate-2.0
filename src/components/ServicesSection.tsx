...
const services = [
  ...
  },
  {
    ...
    title: "AI Automation",
    text: "Intelligent workflows that eliminate repetitive tasks, reduce costs, and free your team to focus on growth.",
  },
  {
    color: "#06b6d4",
    icon: (
    ...
    text: "AI-powered voice systems that handle calls, qualify leads, and support customers around the clock.",
  },
  {
    color: "#818cf8",
    icon: (
